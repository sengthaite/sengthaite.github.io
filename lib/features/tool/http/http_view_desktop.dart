...
class _HttpViewDesktopState extends State<HttpViewDesktop> {
  ...
  Widget build(BuildContext context) {
    final response = context.watch<HttpRequestBuilder>().responseBody;
    return ChangeNotifierProvider(
      create: (_) => widget.requestBuilder,
      child: Row(
          ...
          Expanded(
            child: Column(
              children: [
                    ...
                    SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        onChanged: (value) => setState(
                            () => allowSubmitRequest = value.isNotEmpty),
                      ),
                    ),
                    const SizedBox(
                      width: 10,
                ...
                Expanded(
                  child: Center(
                    child: Text(response ?? "Empty response"),
                  ),
                )
              ],
            ),
